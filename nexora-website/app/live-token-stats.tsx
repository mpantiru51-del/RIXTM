  ...
  return (
    <section className="live-stats" aria-label="Statistici live RIXTM">
      <div className="live-stats-heading">
        <div>
          <span className={`status-dot${stats.live ? " is-live" : ""}`} />
          DATE ON-CHAIN
        </div>
      ...
      <div className="live-stats-grid">
        ...
        <a className="live-stat-card" href={TOKEN_URL} target="_blank" rel="noreferrer">
          ...
          <div>
            <small>HOLDERS</small>
            <strong>{numberOrDash(stats.holders)}</strong>
          </div>
        </a>

        <a
          className="live-stat-card"
          href={`${CONTRACT_URL}#tokentxns`}
          target="_blank"
          rel="noreferrer"
        >
          <span className="live-stat-icon" aria-hidden="true">↻</span>
          <div>
            ...
            <strong>{numberOrDash(stats.totalTransactions)}</strong>
          </div>
        </a>
        ...
        <a className="live-stat-card" href={TOKEN_URL} target="_blank" rel="noreferrer">
          ...
          <div>
            ...
            <strong>{stats.circulatingSupply}</strong>
            <em>RIXTM</em>
          </div>
        </a>
      </div>
